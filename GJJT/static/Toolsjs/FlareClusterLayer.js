...
define(["require",
    ...
    "esri/views/2d/engine/graphics/Projector",
    ...
    "dojo/query",
    "dojo/dom-attr",
    "dojo/dom-style"], function (require, exports, GraphicsLayer, SimpleMarkerSymbol, TextSymbol, SimpleLineSymbol, Color, watchUtils, webMercatorUtils, Graphic, Point, Multipoint, Polygon, geometryEngine, SpatialReference, GFXObject, Projector, asd, on, gfx, domConstruct, query, domAttr, domStyle) {
    "use strict";
    ...
    var FlareClusterLayer = /** @class */ (function (_super) {
        ...
        function FlareClusterLayer(options) {
            ...
            //该比例尺停止聚合并显示单点
            _this.clusterToScale = options.clusterToScale || 8000;
            // 最小聚合数量
            _this.clusterMinCount = options.clusterMinCount || 2;
            // flare单个目标显示的提示框属性
            _this.singleFlareTooltipProperty = options.singleFlareTooltipProperty || "name";
            // when to display the area (convex hull) of the points for each each cluster
            ...
            // maximum number of single object flares before converting to aggregated flares
            _this.maxSingleFlareCount = options.maxSingleFlareCount || 8;
            // whether to display flares, default to true
            _this.displayFlares = options.displayFlares === false ? false : true;
            // whether to display sub type flares, ie: flares that represent the counts of a certain property of the data that is clustered
            _this.displaySubTypeFlares = options.displaySubTypeFlares === true;
            // the property name that the subtype flare will use to count on
            _this.subTypeFlareProperty = options.subTypeFlareProperty || undefined;
            // buffer between flares and cluster
            ...
            // whether this layer should refresh the clusters and redraw when stationary is true, default to true
            _this.refreshOnStationary = options.refreshOnStationary === false ? false : true;
            ...
            _this.textSymbol = options.textSymbol || new TextSymbol({
                ...
                // setting yoffset as vertical alignment doesn't work in IE/Edge
                yoffset: -3
            });
            ...
            _this.on("layerview-create", function (evt) {
                return _this._layerViewCreated(evt);
            });
            if (_this._data) {
                _this.draw();
            }
        ...
        FlareClusterLayer.prototype.draw = function (activeView) {
            ...
            for (var i = 0; i < dataLength; i++) {
                ...
                xVal = obj.geometry.longitude;
                yVal = obj.geometry.latitude;
                if (!xVal) {
                    continue;
                }
        ...
        FlareClusterLayer.prototype._createSingle = function (obj) {
            var point = new Point({
                longitude: obj.geometry.longitude, latitude: obj.geometry.latitude
            });
        ...
        FlareClusterLayer.prototype._cSToMaxScale = function (objList) {
        ...
        FlareClusterLayer.prototype._initFlares = function () {
            ...
            var _loop_1 = function (i_2, len_1) {
                ...
                // f.flareGroup.mouseEnter = on.pausable(f.flareGroup.rawNode, "mouseenter", function () {
                //     return _this._createTooltip(f);
                // });
                // f.flareGroup.mouseLeave = on.pausable(f.flareGroup.rawNode, "mouseleave", function () {
    ...
    var PointFilter = /** @class */ (function () {
        function PointFilter(filterName, propertyName, values, keepOnlyIfValueExists) {
            if (keepOnlyIfValueExists === void 0) {
                keepOnlyIfValueExists = false;
            }
