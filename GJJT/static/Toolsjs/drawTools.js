define([
  ...
  let view = {};
  let buffer = 0;
  let ifReturnGeometry = false ;
  let bufferGeometry={};
  return { drawGeometry,ifReturnGeometry,bufferGeometry }
  function drawGeometry(type,draw,view,buffer) {
    this.type = type;
    this.view = view;
    ...
    action.ifReturnGeometry = this.ifReturnGeometry;
    this.view.focus();
  ...
  //返回扩展区或者多边形数据
  function _returnGeometry(event){
    this.view.graphics.removeAll();
    let Graphic = {}
    if(this.type==='multipoint'){
      Graphic ={
