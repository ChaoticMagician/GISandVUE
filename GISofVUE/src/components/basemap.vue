  ...
  methods: {
    createMap () {
      ...
      esriLoader.loadModules([
        ...
        "esri/geometry/Point",
        "esri/Graphic"
      ]).then(([EsriMap,MapView,FeatureLayer,Point,Graphic]) => {
        ...
        function createLayer(graphics) {
          ...
          layer = new FeatureLayer({
            ...
            renderer: citiesRenderer, // set the visualization on the layer
          });
          return layer;
        }

        var graphicsOBJ = createGraphics(geojsontest);
        console.log(graphicsOBJ);
        // var layer = createLayer(graphicsOBJ);
        ...
        view.when(view.graphics.addMany(graphicsOBJ));
      })
    }
  }
}
