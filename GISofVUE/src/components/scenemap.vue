  ...
  methods: {
    createMap () {
      ...
      esriLoader.loadModules([
        ...
        "esri/widgets/Home",
        "dojo/domReady!"
      ]).then(([Map,SceneView,FeatureLayer,Home]) => {
        //map代码开始锚点

        var wellsUrl ="https://services.arcgis.com/V6ZHFr6zdgNZuVG0/arcgis/rest/services/HarperSumnerOGWells/FeatureServer/0";
        ...
        var map = new Map({
          basemap: "topo",
          layers: [quakesDepthLayer, quakesSurfaceLayer, wellsLayer,
            wellsSurfaceLayer
          ],
          ground: {
        ...
        view.popup.on("trigger-action", function(event) {
          if (event.action.id === "find-wells") {
            ...
            wellsLayer.queryFeatureCount(wellsBufferParams).then(function(
              response) {
